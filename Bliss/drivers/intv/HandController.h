...
enum
{
    ...
    CONTROLLER_KEYPAD_ROW_1 = 0x01,
    CONTROLLER_KEYPAD_ROW_2 = 0x02,
    CONTROLLER_KEYPAD_ROW_3 = 0x04,
    CONTROLLER_KEYPAD_ROW_4 = 0x08,

    CONTROLLER_KEYPAD_COLUMN_3 = 0x20,
    CONTROLLER_KEYPAD_COLUMN_2 = 0x40,
    CONTROLLER_KEYPAD_COLUMN_1 = 0x80,

    CONTROLLER_KEYPAD_1 = 0x81,
    CONTROLLER_KEYPAD_2 = 0x41,
    CONTROLLER_KEYPAD_3 = 0x21,
    CONTROLLER_KEYPAD_4 = 0x82,
    CONTROLLER_KEYPAD_5 = 0x42,
    CONTROLLER_KEYPAD_6 = 0x22,
    CONTROLLER_KEYPAD_7 = 0x84,
    CONTROLLER_KEYPAD_8 = 0x44,
    CONTROLLER_KEYPAD_9 = 0x24,
    CONTROLLER_KEYPAD_0 = 0x48,
